...
const teamData = [
  ...
  { name: 'Abdul Malik Dzakwan S', role: 'Hipster', image: './public/tentang kami/co1.jpg' },
  { name: 'Alexandro Bilbilson D', role: 'Scrum Master/Hacker', image: './public/tentang kami/co1.jpg' },
  { name: 'Nabilah Rahmah H', role: 'Hipster', image: './public/tentang kami/co1.jpg' },
  { name: 'M. Faiz Nurochman', role: 'Hacker', image: './public/tentang kami/p4.jpg' },
  { name: 'Vina Dhamayanti', role: 'Hacker', image: './public/tentang kami/co1.jpg' },
